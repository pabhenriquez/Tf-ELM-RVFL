...
class LRFELMModel(BaseEstimator, ClassifierMixin):
    """
        ...
        According to the literature, LRF-ELM was designed for IMAGE CLASSIFICATION tasks,
        combining random convolutional filters with ELM for efficient image recognition.
