...
class WELMLayer(ELMLayer):
    """
        Weighted Extreme Learning Machine (WELM) Layer.
        ...
        According to the literature, WELM was designed specifically for CLASSIFICATION tasks
        with imbalanced class distributions. The weighting mechanism adjusts sample importance
