...
class USELMLayer:
    """
        Unsupervised Extreme Learning Machine (US-ELM) Layer.
        ...
        For classification/regression, use ELMLayer with ELMModel instead.

        According to the literature, US-ELM was designed for UNSUPERVISED learning tasks
        including dimensionality reduction, data visualization, feature extraction,
        and clustering. It uses graph Laplacian regularization to preserve data structure.
